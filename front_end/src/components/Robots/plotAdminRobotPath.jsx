...
class PlotAdminRobotPath extends Component {
    constructor(props) {
        super(props);
        this.state = {
            robot: [],
        ...
        return (
            <div>
                <Sidebar>
                    <br />
                    <div>
                        <h1 id='title' style={{ fontSize: "20px", marginLeft: "40px" }}>Robot Path : {this.state.robot.roboName}</h1>
                        <br />
                        <table id='students' style={{ marginLeft: "20%" }}>
                            <tr key="heading" style={{ borderColor: "black", borderWidth: "1px", padding: "20px" }}>
...
export default PlotAdminRobotPath;
